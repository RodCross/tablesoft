...
public class UsuarioPUCP {
    private int codigo_pucp;
    private int dni;
    private String nombre;
    private String correo_electronico;

    public UsuarioPUCP(int codigo_pucp, int dni, String nombre) {
        this.codigo_pucp = codigo_pucp;
        this.dni = dni;
        this.nombre = nombre;
    }

    public UsuarioPUCP(int codigo_pucp, int dni, String nombre, String correo_electronico) {
        this.codigo_pucp = codigo_pucp;
        this.dni = dni;
        this.nombre = nombre;
